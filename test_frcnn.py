...
test_path = 'Annotation file/test/test_annotation.txt' # Test data (annotation file)

test_base_path = 'DataSet/test' # Directory to save the test images
...
for idx, img_name in enumerate(imgs_path):
	...
	print(all_dets)
	# cv2.imwrite(f"test_img{count}.jpg",img)
